...
app.use(cors({ origin: ['http://localhost:3000','http://localhost:3001','https://personal-portfolio-portfoliodashboard.vercel.app','https://amdad-dev.vercel.app'], credentials: true }))
